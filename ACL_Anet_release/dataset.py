...
class SingleVideoDataset(Dataset):
    ...
    def __init__(self,
        ...
        # some videos may have more than one labels, if single_label==True, will make
        # these videos as multi videos with single labels, but the weight will be reduced
    ...
    def __getitem__(self, idx):
        ...
        if self.single_label:
            return_dict['label'] = np.array(self.dataset_dict[video]['label_single'])
            return_dict['weight'] = np.array(self.dataset_dict[video]['weight'])
